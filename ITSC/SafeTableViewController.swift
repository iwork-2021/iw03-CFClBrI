...
class SafeTableViewController: UITableViewController {
    ...
    private func fetchData() {
        let url = URL(string: "https://itsc.nju.edu.cn/aqtg/list.htm")!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "safeCell", for: indexPath) as! TableViewCell

        // Configure the cell...
        if self.titles.count == 8 && self.times.count == 8 {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "safeContent" {
...
extension SafeTableViewController: URLSessionDataDelegate {
            ...
            if let error = error {
                ...
                do {
                    ...
                    for match in matches {
                        ...
                        let timePos: Int = regResString.range(of: "-", options: .backwards).lowerBound - 7
